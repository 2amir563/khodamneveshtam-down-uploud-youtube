            ...
            for quality_key in quality_order:
                if quality_key in QUALITY_LABELS:
                    ...
                    if size_est:
                        ...
                        if quality_key == "best":
                            label = f"🎬 Best (Unknown size)"
                        elif quality_key == "audio":
                            label = f"🎵 Audio (Unknown size)"
                        else:
